...
import org.serratectrabalho.atividadee.atividade4base.exception.RecursoNaoEncontradoException;
...
public class FuncionarioController {
    ...
    public ResponseEntity<Funcionario> buscarPorId(@PathVariable Long id) {
        ...
        Funcionario funcionario = repository.findById(id)
                .orElseThrow(() ->
                        new RecursoNaoEncontradoException("Funcionário " + id + " não encontrado tente outro nome por favor"));
